...
function Sidebar({ isOpen, setIsOpen }) {
  return (
    <>
      {/* desktop */}
      <div
        className="hidden lg:block h-full fixed z-10 top-0 left-0 bg-pink-300 w-[309px]
      ...
      >
        <div className="flex flex-col justify-between h-full ">
          <div>
            <div className="pl-11">
            <Link to="/dashboard">
            <img src={logo} width={150}  alt="" style={{ borderRadius: '60%' }}/>
            </Link>
            </div>
            {/* New Topic */}
            <button
              className="border-[1px] bg-white rounded-lg pl-6 py-[22 px] w-full
                text-left mt-10 mb-5 flex items-center "
            >
              <img src={plus} alt="" />
              <span className="ml-6 font-semibold text-lg text-pink-500">
                New Topic
              </span>
            </button>
