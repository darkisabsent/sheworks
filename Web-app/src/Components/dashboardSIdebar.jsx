import logo from "/assets/selim.png";
...
function DashboardSIdebar({ isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      {/* desktop */}
      <div
        className="hidden lg:block h-full fixed z-10 top-0 left-0 bg-pink-300 w-[250px]
          overflow-x-hidden pt-7 border-[#bbbac2] border-r-[1px] pl-6 pr-4"
      >
        <div className="flex flex-col justify-between h-full ">
          <div>
          <Link to="/">
  <img src={logo} width={200} alt="" style={{ borderRadius: '50%', height: '200px' }} />
</Link>
            <div className="mt-8 ml-1 flex flex-col gap-6">
              <NavLink
                className={({ isActive }) =>
                  isActive ? "bg-pink-200 p-3 rounded-lg" : ""
                }
                to="/dashboard"
              >
              ...
              <NavLink
                className={({ isActive }) =>
                  isActive ? "bg-[#f8f838] p-3 rounded-lg" : ""
                }
                to="/chat"
              >
                <div className="flex gap-2">
      ...
      {isOpen && (
        <div
          className="lg:hidden h-full fixed z-20 top-0 left-0 pl-6 pr-4 w-[309px]
                overflow-x-hidden pt-7 border-[#E6E5EE] border-r-[1px]   bg-[#b429a6]"
        >
          <div
